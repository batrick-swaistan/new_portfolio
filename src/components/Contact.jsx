...
const Contact = () => {
  return (
    <div name="contact" className='w-full md:h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white pt-20'>
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action='https://getform.io/f/e1018c28-6c4a-47d2-84c6-2036e4934922'  method="POST" className='flex flex-col w-full md:w-1/2'>
                     <input type="text" 
                     name="name" 
